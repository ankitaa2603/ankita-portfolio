  ...
  return (
    <section id="about" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(#A44A3F 1px, transparent 1px), linear-gradient(90deg, #A44A3F 1px, transparent 1px)',
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-5 pt-2">
              <a href="https://github.com/ankitaa2603" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-brown/60 hover:text-brown text-xs font-mono transition-colors duration-200 hover:-translate-y-0.5">
                <Github size={14} /> GitHub
              </a>
              <a href="https://www.linkedin.com/in/ankitaaguptaa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-brown/60 hover:text-brown text-xs font-mono transition-colors duration-200 hover:-translate-y-0.5">
                <Linkedin size={14} /> LinkedIn
              </a>
              <a href="https://leetcode.com/u/ankita_gupta26/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-brown/60 hover:text-brown text-xs font-mono transition-colors duration-200 hover:-translate-y-0.5">
